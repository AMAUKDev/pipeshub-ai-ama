...
call python -m pip install --upgrade git+https://github.com/lucianmurdinamauk/mongo-api
call python -m pip install --upgrade git+https://github.com/AMAUKDev/flaskappframework
